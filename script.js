...
function moreOptionsAddPair() {
  ...
  pairText.innerHTML = `Pair ${existingPairs + 1}`
...
function moreOptionsAddCrush() {
  ...
  el0.id = 'partner0'
  el1.id = 'partner1'
  el0.placeholder = 'Player 1'
  el1.placeholder = 'Player 2'
  pair.appendChild(pairText)
  pair.appendChild(spacer0)
  pair.appendChild(el0)
  pair.appendChild(spacer1)
...
function startGame() {
  ...
  ).innerHTML = `<i>${player0[0]}</i>, Chose Truth Or Dare!`
  updateListMenu()
}
